...
public class Level1AState extends GameState {
	...
	public void init() {
		...
		clouds = new Background("/Backgrounds/hillsback.gif", 0.1);
		mountains = new Background("/Backgrounds/houses.gif", 0.3);
		hills2 = new Background("/Backgrounds/hillsfront.gif", 0.2);
	...
	private void populateEnemies() {
		enemies.clear();
		/*
		 * Tengu t = new Tengu(tileMap, player, enemies); t.setPosition(1300, 100);
		 * enemies.add(t); t = new Tengu(tileMap, player, enemies); t.setPosition(1330,
		...
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1320, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1340, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1660, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1680, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(1700, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(2177, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(2960, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(2980, 300);
		enemies.add(gp);
		gp = new GelPop(tileMap, player);
		gp.setPosition(3000, 300);
		enemies.add(gp);
	...
	public void update() {
		...
		hills2.setPosition(tileMap.getx(), tileMap.gety());
		...
		// update enemy projectiles => inutile pour le moment
	...
	public void draw(Graphics2D g) {
		...
		//enemy projectiles => inutile pour le moment
		for (int i = 0; i < eprojectiles.size(); i++) {
