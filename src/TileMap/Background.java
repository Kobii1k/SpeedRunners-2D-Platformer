...
//classe gérant les images de fond
public class Background {
	...
	//4 constructeurs de Background selon la nécessité
	//BG dans le menu pause, menu principal ou en plein jeu.
	
	public Background(String s) {this(s, 0.1);}
	public Background(String s, double d) {this(s, d, d);}
